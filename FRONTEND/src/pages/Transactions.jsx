        ...
        <>
          ...
          <div className="md:hidden space-y-4">
            {transactions.map((tx, idx) => (
              <div
                key={tx.collect_id}
                className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 bg-white dark:bg-gray-800 shadow-md"
              >
                {/* Header */}
                <div className="flex justify-between items-center mb-3">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-gray-200">
                    #{idx + 1} • School:{" "}
                    <span className="font-semibold">{tx.school_id}</span>
                  </h3>
                  <span
                ...
                <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-gray-50 dark:bg-gray-900/40 p-2 rounded-lg text-center">
